...
namespace Study.Test
{
    public class LocalTPS : TestKit
    {
        ...
        public void TestLocalTps()
        {
            ...
            TestActor.Tell(msg, ActorRefs.NoSender);
            }
            var ret = ReceiveN(1024 * 1024 * 3, 1.Seconds());
